...
// import {EducationdetailService} from "./educationdetail.service";
//
// registerLocaleData(localeEs);
// type MyArrayType = Array<{ value: string }>;
//
// @Component({
//   selector: 'education-detailprofile',
//   templateUrl: './educationdetail.component.html',
//   styleUrls: ['./educationdetail.component.scss'],
...
//     private studentprofieservice: EducationdetailService,
...
//       Input: encryptUsingAES256(jsonin),
//     };
//     this.studentprofieservice.Final_profileSubmitted(jsonin_input).subscribe((response) => {
