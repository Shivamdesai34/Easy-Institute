...
export class NewprofileComponent implements OnInit {
  ...
  private gridApi: any;
  res_finalsubmitprofile: boolean=true;
  ...
  ngOnInit(): void {
    ...
    if (this.oSession.registerfinyear == myGlobals.Global_CurrentFinYear) {
      ...
      if (this.oSession.currentformfeesbatchcode! > 0) {
        this.single_batch();
        // if (this.oSession.maxadmissionboard == 'UG' || this.oSession.maxadmissionboard == 'JR') {
        //   if (this.oSession.submittedyear! < myGlobals.Global_CurrentFinYear) {
        //
        //     if (this.oSession.maxadmissionboard == 'UG' && this.oSession.maxbatchlevel == 3) {
        //       this.CreateForm();
        //     }
        //
  ...
  onSavedetails() {
    ...
    this.commonService
      .Post_json_normal<boolean>(Students_url.IU_Personalinfo, input_json)
      .subscribe((response) => {
        if (response == null) {
  ...
  IU_Parents() {
    ...
    this.commonService
      .Post_json_normal<boolean>(Students_url.IU_Parents, input_json)
      .subscribe((response) => {
        if (response == null) {
          this.globalmessage.Show_error('Please check your details');
        }
  ...
  IU_Address() {
    ...
    this.commonService
      .Post_json_normal<boolean>(Students_url.IU_Address, input_json)
      .subscribe((response) => {
        if (response == null) {
          this.globalmessage.Show_error('Please check your details');
        }
  ...
  IU_Nationalty() {
    ...
    this.commonService
      .Post_json_normal<boolean>(Students_url.IU_Nationalty, input_json)
      .subscribe((response) => {
        if (response == null) {
          this.globalmessage.Show_error('Please check your details');
        }
  ...
  IU_Others() {
    ...
    this.commonService
      .Post_json_normal<boolean>(Students_url.IU_Others, input_json)
      .subscribe((response) => {
        if (response == null) {
          this.globalmessage.Show_error('Please check your details');
        }
  ...
  saveReservDetails() {
    ...
    this.commonService.Post_formdata(Students_url.IU_Reservations_new, formdata).subscribe((response) => {
      if (response.data == true) {
        this.globalmessage.Show_message('Data uploaded successfully');
  ...
  ProfileResource() {
    this.commonService
      .Post_json_data<Res_ProfileResources>(Students_url.ProfileResources, "")
      .subscribe((response) => {
  ...
  Final_ProfileSubmitted() {
    ...
    this.commonService.Post_json_normal<boolean>(Students_url.ProfileSubmited, jsonin_input).subscribe((response) => {
