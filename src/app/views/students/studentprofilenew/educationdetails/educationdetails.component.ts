...
//             const raw = rowGroup.getRawValue();
//             const file = this.Documentfiles[i];
//             const mandaten = Number(raw.mandatory);
//
// // ❗ remove file object from raw
//             delete raw.file;
//
//             educationPayload.push({
//                 ...raw,
//
//                 // ✅ ALWAYS send file key
//                 file: file ? file.name : "",
//
//                 // ✅ number safety
//                 marksobtained: Number(raw.marksobtained),
//                 outoff: Number(raw.outoff),
//                 percentage: Number(raw.percentage),
//                 sgpa: Number(raw.sgpa),
//                 sgpa_percentage: Number(raw.sgpa_percentage)
//             });
