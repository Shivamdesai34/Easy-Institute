...
export class StudentProfileNewComponent implements OnInit {
    ...
    CreateForm() {
        ...
        // this.studentDetailsForm.controls['abc_account_id'].valueChanges.pipe(
        //     debounceTime(500),
    ...
    onSavedetails() {
        ...
        // let result = this.formatDate(this.studentDetailsForm.controls['DOB'].value);
        // console.log(result); // 2009-09-12
        //

        // this.studentDetailsForm.controls['DOB'].setValue(result)


        this.commonService
            .Post_json_data<boolean>(Students_url.IU_Personalinfo, this.studentDetailsForm.value)
            .subscribe((response) => {
                if (response == null) {
    ...
    //     };
    //
    //     const groupName = stepMap[this.activestep];
    //     return this.stepperForm.get(groupName)?.valid ?? false;
    // }
    ...
    personalInfo() {
        ...
        this.commonService
            ...
            .subscribe((response) => {
                ...
                //Shivam25/04
                // const blob_first_photoimg = this.ires_personalinfo.photo_image.substring(0, 200)
                // // const cut_data = blobdata.substring(201,33)
                // const last_date_photoimg = this.ires_personalinfo.photo_image.substring(232, this.ires_personalinfo.photo_image.length)
                // const mystring_photoimg = blob_first_photoimg + last_date_photoimg
                // const blob_first_signature = this.ires_personalinfo.signature_image.substring(0, 200)
                // // const cut_data = blobdata.substring(201,33)
                // const last_date_signature = this.ires_personalinfo.signature_image.substring(232, this.ires_personalinfo.signature_image.length)
                ...
                if(this.ires_personalinfo.firstname.length > 0){
                    this.stepperLoaded = true;
                }
