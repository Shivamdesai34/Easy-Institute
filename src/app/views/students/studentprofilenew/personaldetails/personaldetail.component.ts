...
export class PersonalDetailsComponent implements OnInit {
    ...
    Createform() {
        ...
        // this.checkfinalSubmit.controls['checkprofile'].valueChanges.subscribe((value) => {
        //     if(value == false){
        //         this.checkfinalSubmit.invalid
        //     }
        // })
    ...
    showPreview(event: any) {
        ...
        //
        //                 console.log('Compressed File object:', compressed_image);
        //
        //                 this.imageChangedEvent = compressed_image
        //
